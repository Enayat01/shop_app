...
class Authentication with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlPart?key=AIzaSyByLtHXLkENdD7_jGVk9Kb-yZUaFGiPb6I');
    try {
      ...
      print('Token is:${responseData['idToken']}');
  ...
  Future<bool> tryAutoLogin() async {
    ...
    final extractedUserData = json.decode(userPref!) as Map<String, Object>;
    final expiryDate =
